...
class HairCutAnimationPage extends CupertinoPageRoute {
   HairCutAnimationPage()
      : super(builder: (BuildContext context) => new HaircutBooking());
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return new FadeTransition(
        opacity: animation, child: new HaircutBooking());
  }
}
