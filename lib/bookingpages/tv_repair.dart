...
class TvServiceAnimationPage extends CupertinoPageRoute {
   TvServiceAnimationPage()
      : super(builder: (BuildContext context) => new TvRepairService());
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    return new FadeTransition(
        opacity: animation, child: new TvRepairService());
  }
}
